...
const COMMANDS = [
  ...
  { id: 'keys', label: 'API Keys', icon: '06', tab: 'keys', keywords: 'auth token credential developer' },
  { id: 'models', label: 'Service Routes', icon: '07', tab: 'models', keywords: 'ai model gateway claude gpt' },
  { id: 'connections', label: 'Connections', icon: '08', tab: 'connections', keywords: 'oauth provider connect' },
  { id: 'treasury', label: 'Settlement Wallet', icon: '09', tab: 'treasury', keywords: 'usdc solana balance treasury' },
  { id: 'future-apis', label: 'Integrations', icon: '10', tab: 'future-apis', keywords: 'helius jupiter phantom discord webhook' },
