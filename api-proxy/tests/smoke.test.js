...
describe('Vercel routing', () => {
  ...
  it('Vercel function wraps the Express app', () => {
    ...
    assert.ok(src.includes("req.url === '/resource-packs'"), 'function should preserve /v1 resource-pack API routes after Vercel path rewrite');
    assert.ok(src.includes("req.url === '/policy'"), 'function should preserve /v1 policy API routes after Vercel path rewrite');
